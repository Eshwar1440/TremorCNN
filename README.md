...
Bandpass filter (1-8 Hz)
        ↓
Short-Time Fourier Transform → spectrogram patch (45 × 10)
        ↓
...
→ Conv2d(1→16, 3×3) + ReLU + MaxPool2d(2)   # → (16, 22, 5)
→ Conv2d(16→32, 3×3) + ReLU + MaxPool2d(2)  # → (32, 11, 2)
...
Data is fetched automatically from IRIS. No downloads needed.
...
- Cross-zone generalization (Parkfield San Andreas, Shikoku Japan)
